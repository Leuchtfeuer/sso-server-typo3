...
class tx_nawsinglesignon_pi1_wizicon {
	...
	function proc($wizardItems) {
		...
		$wizardItems['plugins_tx_nawsinglesignon_pi1'] = array('icon' => t3lib_extMgm::extRelPath('naw_single_signon') . "pi1/ce_wiz.gif", 'title' => $LANG->getLLL('pi1_title', $LL), 'description' => $LANG->getLLL('pi1_plus_wiz_description', $LL), 'params' => '&defVals[tt_content][CType]=list&defVals[tt_content][list_type]=naw_single_signon_pi1');
		return $wizardItems;
	}
